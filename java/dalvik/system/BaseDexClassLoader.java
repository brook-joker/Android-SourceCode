...
public class BaseDexClassLoader extends ClassLoader {
     ...
     * 报告用于自定义dex文件加载方式的挂钩。
     *
     * 这使框架能够监视dex文件的使用。 目标是简化优化外部dex文件的机制，并进一步优化辅助dex文件。
     ...
     *
     * 报告仅在构建BaseDexClassLoader的新实例时发生，并且仅在设置此字段后才处于活动状态
     ...
     * 一旦设置，BaseDexClassLoader的所有新实例都将报告构造加载的dex文件。
     *
