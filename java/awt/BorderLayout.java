...
public class BorderLayout implements LayoutManager2,
     ...
     * 相对定位常数,可以代替北,难,东,西或者中心
     * 混合使用两种常数会导致不可预料的结果。如果你使用了这两种类型,相对常数将优先。
     * 例如:如果在方向为左到右的容器中添加使用NORTH和BEFORE_FIRST_LINE常量,
     * 则只有BEFORE_FIRST_LINE将被布局,同样适用于lastLine, firstItem, lastItem.
     *
     * @serial
     */
    Component firstLine;
