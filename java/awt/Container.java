...
public class Container extends Component {
    ...
    public Insets insets() {
        ComponentPeer peer = this.peer;8
     ...
     * 指明有效的容器是否也应该遍历它们的孩子,并调用它们的validateTree()方法
     *
     ...
     * static.
     *
     * 只要TreeLock本身是静态的,那么这个字段也被允许为静态的
     *
     ...
     * 递归地向下遍历容器树,计算那么被标记为需要的子树(那些标记被视为无效)
     * 同步需要调用以下方法<code>validate</code>.
     *
     * @see #doLayout
     * @see #validate
     */
