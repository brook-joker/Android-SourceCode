...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    */
     ...
     *
     * 如果当前的View不需要任何绘制 设置这个标记以便未来的需求,默认情况下,这个标记是不在View里设定的
     * 但是可以在一些View的子View例如ViewGroup去设置
     *
     *
     * 典型的使用场景是 如果你需要复写onDraw那么你需要清除这个标记
    ...
    */
    ...
    public final int getHeight() {
        return mBottom - mTop;0x7f0b0129
    }
     ...
     * <p>
     * This must be called from a UI thread. To call from a non-UI thread, call
     * 必须运行在UI线程  如果要运行在非UI线程 请调用postInvalidate()
     * {@link #postInvalidate()}.
     */
