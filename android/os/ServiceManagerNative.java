 ...
 *
 * ServiceManager的实现类,大多数客户端将只关心 getDefault()和 asInterface()
 * @hide
 */
public abstract class ServiceManagerNative extends Binder implements IServiceManager
{
     ...
     * a proxy if needed.
     *
     * 将一个Binder类转换成一个ServiceManger接口,如果有必要的话生成一个代理
     */
