...
public class Resources {
     ...
     * 这个类拥有特定主题的当前属性值。换言之，主题是资源属性的一组值。
     * 这些结合使用{@link TypedArray}来解析属性的最终值。
     *
     ...
     * 主题的属性以两种方式发挥作用：（1）样式属性可以通过“？themeAttribute”语法显式引用主题中的值;
     * （2）如果没有为特定的样式属性定义值，作为最后的手段，我们将尝试在主题中找到该属性的值。
     * 
